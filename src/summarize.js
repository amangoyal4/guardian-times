...
Rewrite this raw news item into Guardian Capital Brief editorial — substantive, specific, and tight. Reason about what actually matters before you write. Return ONLY JSON, no markdown:
{
  ...
  "soWhat": "${lead ? 'two or three sentences' : 'one or two sentences'} of genuine analysis — the 'so what' the source won't tell them: who is affected and which way, the second-order effect, and the specific thing to watch next. WRITE THE INSIGHT DIRECTLY. NEVER open with, or otherwise state, who the reader is — BANNED openers include 'For investment professionals…', 'For Indian wealth and PMS/AIF professionals…', 'For investors…', 'For advisors…' and any 'For [audience], this…' construction. The reader is already a sophisticated Indian wealth/PMS/AIF professional; pitch the substance at that level implicitly, don't announce it. Be concrete and news-specific — name the actual sectors, companies, instruments, or portfolio exposures affected and the real mechanism; ban vague filler like 'monitor developments', 'integrate this into your analysis', 'warrants close monitoring', 'in the coming quarters'. Not a restatement of the summary."${chartSpec}
}
